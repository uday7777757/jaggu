...
%-----------------------------------------
\newcommand{\thesistitle}{TITLE OF THE PROJECT} % Title of the Thesis, change here

% -----------------------------------------
% STUDENT INFORMATION 
% ------------------------------------------
\newcolumntype{C}[1]{>{\centering}m{#1}}
\newcommand{\studentA}{Student 1 Name}
\newcommand{\rollA}{Student 1  Roll Number}
\newcommand{\studentB}{Student 2 Name}
\newcommand{\rollB}{Student 2  Roll Number}
\newcommand{\studentC}{Student 3 Name}
\newcommand{\rollC}{Student 3  Roll Number}
\newcommand{\guidename}{Name of the Supervisor}
