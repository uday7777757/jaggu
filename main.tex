...
%-----------------------------------------
\newcommand{\thesistitle}{Customer Churn Prediction for FinTech Platform Using Machine Learning}
...
\newcommand{\rollA}{1234}
\newcommand{\studentB}{Bob B.}
\newcommand{\rollB}{1235}
\newcommand{\studentC}{Carol C.}
\newcommand{\rollC}{1236}
\newcommand{\guidename}{Dr. A. Smith}
\newcommand{\guidedesignation}{Professor}
% ---------------------------------------------

% If the number of people is different, change accordingly in titlepage and bonafide certificate
\newcommand{\thesisdept}{Computer Science \& Engineering}
 % Project Guide
 % Project Guide
\newcommand{\depthodname}{Head of Department}
\newcommand{\depthoddesignation}{Dept. of CSE, XYZ University}
